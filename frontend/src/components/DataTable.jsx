...
//       <div className="overflow-x-auto w-[107rem] mr-[4rem] border-[1px] border-black-250 shadow-md">
...
//         </div>
//       </div>
//       {isOpen && <ModalTicket closeModal={closeModal} ticket={selectedTicket} />}
//     </div>
//   );
// };
...
export const DataTable = () => {
  ...
  return (
    <div className="flex items-end">
      <div className="w-[100%] flex justify-between items-center mb-4 bg-green-800"></div>
